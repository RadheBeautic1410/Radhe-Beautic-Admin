...
const RejectedOrderd = () => {
	...
	const fetchRejectedOrders = async (pageParam: number, pageSizeParam: number, dateRange: DateRange | undefined) => {
	...
	const { isPending, isError, error, data, isFetching, isPlaceholderData } =
		useQuery({
			queryKey: ['rejectedOrders', page, pageSize, dateRange],
			queryFn: () => fetchRejectedOrders(page, pageSize, dateRange),
					...
					<Popover>
						...
						<PopoverContent className="w-auto p-0" align="start">
							<Calendar
								initialFocus
								mode="range"
								defaultMonth={addDays(todayDate, -20)}
								selected={dateRange}
